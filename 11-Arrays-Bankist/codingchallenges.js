...
const checkDogs2 = function (dogsJulia2, dogsKate2) {
  const dogsJuliaCorrected2 = dogsJulia2.slice();
  dogsJuliaCorrected2.splice(0, 1);
  dogsJuliaCorrected2.splice(-2);

  const dogs = dogsJuliaCorrected2.concat(dogsKate2);
  console.log(dogs);
...
calcAverageHumanAge2 = function (ages) {
  const average = ages
...
const avg3 = calcAverageHumanAge3([5, 2, 4, 1, 15, 8, 3]);
const avg4 = calcAverageHumanAge3([16, 6, 10, 5, 6, 1, 4]);
...
const ExactAmount = dogs.includes((dog) => dog.curFood == dog.recFood);
